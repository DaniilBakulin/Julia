function draw_krest_X(rob) ## программа рисует диагональный крест 
    quanity_steps = 0 ## шаги
...
function diog_line(rob,s) ## робот проходит по диагонали и ставит маркеры 
    quanity_steps = 0
...
function go_back!(rob,s1,s2,quanity_steps1)## робот возвращается назад 
